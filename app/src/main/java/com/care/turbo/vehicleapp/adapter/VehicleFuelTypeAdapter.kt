...
class VehicleFuelTypeAdapter (
    private val context: Context,
    private val vehicleFuelType: ArrayList<String>,private val callBacks: CallBacks
) : RecyclerView.Adapter<VehicleFuelTypeAdapter.MyViewHolder>() {
    ...
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): VehicleFuelTypeAdapter.MyViewHolder {
// create a new view
        val view =
    ...
    override fun onBindViewHolder(holder: VehicleFuelTypeAdapter.MyViewHolder, position: Int) {
